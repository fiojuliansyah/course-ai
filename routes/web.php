...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/courses/{course}/syllabus', [SyllabusController::class, 'index'])->name('courses.syllabus.index');
        Route::post('/courses/{course}/syllabus', [SyllabusController::class, 'store'])->name('courses.syllabus.store');
        Route::post('/courses/{course}/syllabus/generate', [SyllabusController::class, 'generateModules'])->name('courses.syllabus.generate');
