...
@section('content')
    @if ($errors->any())
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                <strong class="font-bold">Gagal menyimpan kategori!</strong>
    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <h1 class="text-3xl font-extrabold text-gray-900 mb-6">Buat Kategori Baru</h1>
            
            {{-- FORMULIR CREATE: Mengarah ke CategoryController@store --}}
                ...
                <div class="bg-white shadow-xl rounded-xl p-6 border border-gray-100 max-w-2xl">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" name="description" rows="3" 
                            ...
                            placeholder="Jelaskan fokus utama kategori ini...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
...
@endsection
{{-- @push('scripts') dihilangkan karena tidak ada skrip spesifik di form create --}}