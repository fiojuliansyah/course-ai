...
@section('content')
    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            {{-- FORMULIR UTAMA: Mengarah ke CourseController@store --}}
            <form action="{{ route('admin.courses.store') }}" method="POST" class="space-y-8" enctype="multipart/form-data">
                ...
                <div class="bg-white shadow-xl rounded-xl p-6 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-indigo-400 transition h-full @error('thumbnail') border-red-500 @enderror">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                            ...
                                            {{-- Input file dengan nama 'thumbnail' --}}
                ...
                <div class="bg-white shadow-xl rounded-xl p-6 border border-gray-100">
                    ...
                    <div class="mb-6">
                        ...
                        {{-- Input dengan nama 'short_description' --}}
                ...
                <div class="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                    {{-- Tombol Batal mengarah ke halaman index --}}
...
@push('scripts')
<script>
    // SCRIPT NAVIGASI DI BAWAH (diambil dari layout utama)
    
    // Inisialisasi variabel navigasi dari partial header
    ...
    // Fungsi untuk menutup semua dropdown desktop
    ...
    // 1. Toggle Menu Utama Mobile (Hamburger)
    if (mobileMenuButton) {
    ...
    // 2. Toggle Dropdown Kursus Mobile 
    if(kursusDropdownButtonMobile && kursusMenuMobile && kursusIconMobile) {
        // Asumsi status aktif kursus di set di partial header
    ...
    // 3. Toggle Dropdown Kursus Desktop (Click)
    ...
    // 4. Toggle Dropdown Profile Desktop (Click)
    ...
    // 5. Tutup dropdown desktop saat klik di luar area dropdown
