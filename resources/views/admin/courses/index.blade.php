                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition duration-300 hover:shadow-2xl hover:scale-[1.01]">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex space-x-2 justify-between">
                                ...
                                <a href="{{ route('admin.courses.syllabus.index', $course) }}" class="flex-1 bg-green-100 text-green-700 py-2 rounded-lg text-sm font-medium hover:bg-green-200 transition text-center">Silabus</a>
                                
                                {{-- TOMBOL TAMBAH PERTANYAAN PER KURSUS --}}
